# Домашнее задание к занятию "`Работа с данными (DDL/DML)`" - `Булаев Максим>`
...
SOURCE /home/mabulaev/Downloads/sakila-db/sakila-schema.sql;
SOURCE /home/mabulaev/Downloads/sakila-db/sakila-data.sql;
